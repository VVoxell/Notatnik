...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->usuñToolStripMenuItem->Click += gcnew System::EventHandler(this, &Okno1::usuñToolStripMenuItem_Click);
			// 
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		MessageBox::Show("Proszê wybraæ notatkê do edycji", "Nie wybrano notatki", MessageBoxButtons::OK, MessageBoxIcon::Warning, MessageBoxDefaultButton::Button2);
	}
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		MessageBox::Show("Proszê wybraæ notatkê do usuniêcia", "Nie wybrano notatki", MessageBoxButtons::OK, MessageBoxIcon::Warning, MessageBoxDefaultButton::Button2);
	}
}
